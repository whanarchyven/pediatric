...
const News = () => {
    ...
    const news=[
        ...
        },
        {
            id:0,
            type:'Конференция',
            name:'1 научно-практическая конференция дерматовенерологов и педиатров Алтайского края и Республики Алтай',
            date:'26.09',
        ...
        },
        {
            id:1,
            type:'Конференция',
            name:'6 научно-практическая конференция дерматовенерологов и педиатров Екатеринбурга',
            date:'17.11',
        ...
        },
        {
            id:3,
            type:'Конференция',
            name:'9 научно-практическая конференция дерматовенерологов и педиатров Екатеринбурга',
            date:'11.10',
            image:'/pages/main/news/3.png'
        },
        {
