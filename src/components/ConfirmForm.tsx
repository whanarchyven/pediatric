...
const ConfirmForm = ({closeFunc, price, event_id, event_name, participationType, query,layotBg}: confirmPopInterface) => {
    ...
    const handleSubmit = async () => {
        ...
        await axios.post('/api2/auth/signUp/',{
            firstName,lastName,middleName,email,phoneNumber:phone,password:password,confirmPassword:password
        }).then(async (response)=>{
            console.log(response.data)
            let suka={...response.data}
            console.log(suka)
            console.log(layotBg);
...
</html>`) : (participationType=='offline'?String(`<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:o="urn:schemas-microsoft-com:office:office">
 <head>
  <meta charset="UTF-8">
  <meta content="width=device-width, initial-scale=1" name="viewport">
               ...
               <table width="100%" cellspacing="0" cellpadding="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                 <tr>
                  <td valign="top" align="center" style="padding:0;Margin:0;width:560px">
                   <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                     <tr>
                      <td align="left" style="padding:0;Margin:0"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px"><em><span style="font-size:24px"><strong>Уважаемый участник! {name} </strong></span></em></p></td>
                     </tr>
                   </table></td>
                 </tr>
               </table></td>
               ...
               <table cellpadding="0" cellspacing="0" width="100%" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                 <tr>
                  <td align="center" valign="top" style="padding:0;Margin:0;width:560px">
                   <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                     <tr>
                      <td style="padding:0;Margin:0"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">Спасибо за ваш выбор!<br>Ваша поддержка - наше главное вдохновение.</p></td>
                     </tr>
                     <tr>
               ...
               <table cellpadding="0" cellspacing="0" width="100%" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                 <tr>
                  <td align="center" valign="top" style="padding:0;Margin:0;width:560px">
                   <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                     <tr>
                      <td style="padding:0;Margin:0"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">Спасибо за ваш выбор!<br>Ваша поддержка - наше главное вдохновение. Вы приобрели онлайн участие. Трансляция начнется на странице мероприятия в день конференции по <a href={event_link}>ссылке</a></p></td>
                     </tr>
                     <tr>
                     <td style="aspect-ratio: 16 / 9;display:flex;align-items: center;position:relative;">
                <td>
    ...
    return (
        <div className={'flex gap-4 h-full flex-col'}>
            ...
            {participationType == 'online-free' ?
                <p className={'text-[#0F5F5A] text-lg sm:text-xl'}>Рекомендуем проверить правильность выбора формата
                    мероприятия перед подтверждением.
                </p> :
