               ...
               <table cellpadding="0" cellspacing="0" width="100%" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                 <tr>
                  <td align="center" valign="top" style="padding:0;Margin:0;width:560px">
                   <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                     <tr>
                      <td style="padding:0;Margin:0"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">Спасибо за ваш выбор!<br>Ваша поддержка - наше главное вдохновение. Вы приобрели онлайн участие. Трансляция начнется на странице мероприятия в день выставки <a href={event_link}>ссылке</a></p></td>
                     </tr>
                     <tr>
                     <td style="aspect-ratio: 16 / 9;display:flex;align-items: center;position:relative;">
                <td>
