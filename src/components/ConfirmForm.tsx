                     ...
                     <tr>
                      <td align="right" style="padding:0;Margin:0"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:33px;color:#333333;font-size:22px"><strong><span style="color:#58bbb4">+ 7 985 018 67 84</span><br>техническая поддержка</strong></p></td>
                        ...
                        after_reg_email_placeholders: {
                            ...
                            layoutBg:layotBg,
                            qrCodeUrl:`https://api.qrserver.com/v1/create-qr-code/?size=800x800&data=https://pediatric-dermatology.ru/account/${res.data.uuid}/events/${event_id}`
                        },
                 ...
                 <tr>
                  <td align="center" valign="top" style="padding:0;Margin:0;width:560px">
                   <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                     ...
                     <tr>
                      <td style="padding:0;Margin:0"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">Ваш билет вы можете скачать по ссылке: <a href={linkUrl}>{linkUrl}</a>:</p></td>
                     </tr>
                     <tr>
                     ...
                     <tr>
                      <td align="right" style="padding:0;Margin:0"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:33px;color:#333333;font-size:22px"><strong><span style="color:#58bbb4">+ 7 985 018 67 84</span><br>техническая поддержка</strong></p></td>
                        ...
                        after_pay_email_placeholders: {
                            ...
                            name: String(`${lastName} ${firstName} ${middleName}`),
                            event_id: String(event_id),
                            layoutBg:`https://pediatric.vercel.app/${layotBg}`,
                            linkUrl:`https://pediatric-dermatology.ru/account/${res.data.uuid}/events/${event_id}`,
                            qrCodeUrl:`https://api.qrserver.com/v1/create-qr-code/?size=800x800&data=https://pediatric-dermatology.ru/account/${res.data.uuid}/events/${event_id}`
                        }
                    },
                ).then((response) => {
