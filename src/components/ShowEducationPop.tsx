        ...
        <div className={'fixed z-[999] w-full h-full left-0 top-0 bg-white bg-opacity-10 backdrop-blur-sm flex items-center justify-center'}>
            <div className={'w-3/5 bg-white p-3 rounded-lg border-green-two border-2 flex gap-8 flex-col'}>
                ...
                <div className={'grid-cols-2 grid gap-2'}>
                    ...
                    <p className={'font-semibold text-xl'}>{education.yearStart}</p>
                </div>
                <div className={'grid-cols-2 grid gap-2'}>
                    <p className={'font-normal text-xl'}>Год окончания обучения:</p>
                    <p className={'font-semibold text-xl'}>{education.yearEnd}</p>
                </div>
                <div className={'grid-cols-2 grid gap-2'}>
                    <p className={'font-normal text-xl'}>Наименование учебного заведения:</p>
                    <p className={'font-semibold text-xl'}>{education.university}</p>
                </div>
                <div className={'grid-cols-2 grid gap-2'}>
                    <p className={'font-normal text-xl'}>Наименование факультета:</p>
                    <p className={'font-semibold text-xl'}>{education.faculty}</p>
                </div>
                <div className={'grid-cols-2 grid gap-2'}>
                    <p className={'font-normal text-xl'}>Образование:</p>
                    <p className={'font-semibold text-xl'}>{education.degree}</p>
                </div>
