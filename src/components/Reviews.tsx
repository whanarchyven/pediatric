...
export default function Reviews() {
    ...
    return (
        <div className={'flex items-center'}>
            <div
                className={'cursor-pointer mr-2 flex items-center p-3 justify-center w-14 aspect-square rounded-full bg-[#E4F0EE] hover:bg-[#BCDBD5] transition-all duration-300'}
                onClick={handlePrev}>
            ...
            <div
                className={'cursor-pointer ml-2 flex items-center p-3 justify-center w-14 aspect-square rounded-full bg-[#E4F0EE] hover:bg-[#BCDBD5] transition-all duration-300'}
                onClick={handleNext}>
