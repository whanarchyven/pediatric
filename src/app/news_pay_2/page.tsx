    ...
    return (
        <main className={'overflow-x-hidden'}>
            ...
            <div id={'publications'} className={'bg-white py-20 sm:pt-40 flex flex-col min-h-screen items-center px-[20px] lg:px-[140px] gap-12 '}>
                ...
                <img className={'w-96'} src={'/news_qr2.png'}/>
                <p className={'xl:text-xl text-center text-black font-normal font-inter'}>что бы оплатить, переходите по ссылке <a className={'text-green underline'} href={'http://t.me/dermatology_news_bot'}>http://t.me/dermatology_news_bot</a></p>
