...
export default function Home() {
    ...
    const posts = [
        {
            date: '9 ноября 2024',
            title: `<p class="font-extralight">X Юбилейная конференция с международным участием</p><span class="font-extrabold uppercase">«Дерматологические чтения в педиатрии»</span>`,
