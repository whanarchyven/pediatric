    ...
    const posts = [
        {
            ...
            description: 'На запланированной научной конференции будет организовано обсуждение актуальных вопросов и новаторских подходов в области детской дерматологии, акцентируя внимание на развитии персонализированной медицины. Основное внимание будет уделено анализу проблем, связанных с профилактикой и лечением псориаза у детей, а также изучению возможных стратегий для решения этих задач.\n' +
                '\n',
        ...
        {
            date: '8 июня 2024',
            title: `<p class="font-extralight">II-я научно-практическая конференция</p><span class="font-extrabold uppercase">«Летняя академия детской дерматологии»</span>`,
            description: '08 июня 2024 г. на инновационной площадке - пространство событий для мероприятий цифровой направленности, посвященных прорывным инновациям и новым трендам в мире здравоохранения, состоится ежегодная летняя академия детской дерматологии.\n' +
                '\n',
