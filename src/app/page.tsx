...
export default function Home() {
    ...
    const posts = [
        {
            date: '16 марта 2024',
            title: `<p class="font-extralight">II-я научно-практическая конференция</p><span class="font-extrabold uppercase">«Путь детской дерматологии: от истоков к перспективам. Атопический дерматит»</span>`,
            description: 'В рамках научной конференции предполагается обсуждение современных вопросов и инноваций в сфере детской дерматологии на фоне развития персонализированной медицины. Будет проанализирована проблематика профилактики и терапии атопического дерматита, а также изучены потенциальные стратегии решения указанных вопросов.',
