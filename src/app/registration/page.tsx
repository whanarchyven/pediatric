    ...
    return (
        <main className={'overflow-x-hidden'}>
            ...
            <div
                ...
                <img className={'absolute left-0 bottom-0'} src={`/pages/main/results_bottom_offset.png`}
                     alt={''}></img>

            </div>
            <div
                className={'bg-white py-12 items-center sm:px-[140px] gap-20 grid px-[20px] grid-cols-1 sm:grid-cols-7'}>
                <div className={'w-full col-span-4 flex flex-col gap-6'}>
                    <p className={'text-xl sm:text-3xl font-extralight uppercase'}>Заполните <br/> <span
                        className={'font-extrabold'}>регистрационную анкету</span></p>
                    <form className={'w-full flex flex-col gap-6'}>
                        <div className={'flex flex-col gap-2 w-full'}>
                            <p className={'text-sm sm:text-xl font-light'}>Фамилия<sup className={'text-red '}>*</sup>
                            </p>
                            <input
                        ...
                        <div className={'flex flex-col gap-2 w-full'}>
                            <p className={'text-sm sm:text-xl font-light'}>Отчество<sup className={'text-red '}>*</sup>
                            </p>
                            <input
                                className={'w-full p-2 sm:p-3 rounded-md text-sm sm:text-xl border-2 border-green-two'}
                                name={'surname'}/>
                        ...
                        <div className={'flex flex-col gap-2 w-full'}>
                            <p className={'text-sm sm:text-xl font-light'}>Номер телефона<sup
                                className={'text-red '}>*</sup></p>
                            <input
                                className={'w-full p-2 sm:p-3 rounded-md text-sm sm:text-xl border-2 border-green-two'}
                                name={'surname'}/>
                        </div>
                        <div className={'flex flex-col gap-2 w-full'}>
                            <p className={'text-sm sm:text-xl font-light'}>Специальность<sup
                                className={'text-red '}>*</sup></p>
                            <input
                                className={'w-full p-2 sm:p-3 rounded-md text-sm sm:text-xl border-2 border-green-two'}
                                name={'surname'}/>
                        ...
                        <div className={'flex flex-col gap-2 w-full'}>
                            <p className={'text-sm sm:text-xl font-light'}>Место работы<sup
                                className={'text-red '}>*</sup></p>
                            <input
                                className={'w-full p-2 sm:p-3 rounded-md text-sm sm:text-xl border-2 border-green-two'}
                                name={'surname'}/>
                        ...
                        <div className={'flex flex-col gap-2 w-full'}>
                            <p className={'text-sm sm:text-xl font-light'}>Должность<sup className={'text-red '}>*</sup>
                            </p>
                            <input
                                className={'w-full p-2 sm:p-3 rounded-md text-sm sm:text-xl border-2 border-green-two'}
                                name={'surname'}/>
                        ...
                        <div className={'flex flex-col gap-2 w-full'}>
                            <p className={'text-sm sm:text-xl font-light'}>Пароль<sup className={'text-red '}>*</sup>
                            </p>
                            <input type={'password'}
                                   className={'w-full p-3 rounded-md text-xl border-2 border-green-two'}
                                   name={'surname'}/>
                        </div>
                        <div className={'flex flex-col gap-2 w-full'}>
                            <p className={'text-sm sm:text-xl font-light'}>Укажите пароль повторно<sup
                                className={'text-red '}>*</sup></p>
                            <input type={'password'}
                                   className={'w-full p-3 rounded-md text-xl border-2 border-green-two'}
                                   name={'surname'}/>
                        ...
                        <div className={'flex mt-10 flex-col gap-2 w-full'}>
                            ...
                            <div className={'flex items-center gap-12'}>
                                <div className={'flex cursor-pointer items-center gap-3'} onClick={() => {
                                    setCheckboxRadio('yes')
                                }}>
                                    <div
                                        className={'w-6 aspect-square rounded-md border-2 border-green-two flex justify-center items-center'}>
                                        {checkboxRadio == 'yes' ?
                                            <div className={'w-1/2 aspect-square rounded-full bg-green-two'}>
                        ...
                        <div className={'flex flex-col gap-2 w-full'}>
                            <p className={'text-xs font-light'}>Текущий сайт защищен reCAPTCHA от Google. Порядок защиты
                                персональных данных и условия использования сервиса соблюдены.</p>
                            <div className={'flex items-center gap-12'}>
                                <div className={'flex cursor-pointer items-center gap-3'} onClick={() => {
                        ...
                        <div className={'flex flex-col mt-5 gap-2 w-full'}>
                            <div onClick={()=>{setSended(true)}}
                                className={'w-full p-3 flex items-center justify-center font-extrabold uppercase cursor-pointer rounded-md text-xl text-white bg-green-two'}
                                >{sended?'Спасибо, заявка отправлена на проверку':'Регистрация'}
                            </div>
                        </div>
                    </form>
                </div>
