...
export default function Page({params}: any) {
    ...
    const [event, setEvent] = useState<{
        ...
        announcement: "В ходе конференции будут разобраны наиболее значимые патологии в дерматологии детского возраста, а именно атопический дерматит, формы заболевания и этапы диагностики, а также инновационные технологии терапии. Вас ожидают клинические разборы и детальное рассмотрение тактики ведения пациентов.", avatar: "/pages/new.png", date: "02.12.2023", dateEnd: new Date('02.12.2023'), dateStart: new Date('02.12.2023'), description: 'В фокусе научной программы конференции обсуждение наиболее актуальной проблемы в ведении и лечении псориаза в детском возрасте, а также инновационные возможности в диагностике и профилактике заболеваний кожи у детей.', format: "online", halls: [
            {
                name: 'Трансляция',
                program: [
                    {
