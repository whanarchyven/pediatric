                ...
                {event?.date == '09.11.2024' || event?.date == '2023-11-09' ?
                    <div className={'flex flex-col gap-2'}>
                        ...
                        <p className={'whitespace-pre-wrap mt-2 px-[20px] lg:px-[140px] text-black'}>
                            ...
                            <a className={'font-bold text-green-two'} href={'https://pediatric-dermatology.ru'}>https://pediatric-dermatology.ru</a>
                            (https://pediatric-dermatology.ru/), указав следующие данные: <br/>1. ФИО, <br/>2. Электронный адрес <br/>3. Место работы,
                            ...
                            обратной связи являются "`Чат трансляции`". Участниками мероприятия будут признаны слушатели, присутствующие 9 ноября
                            2024 года (1 день) - не менее 270 минут для программы НМО на трансляции и подтвердившие 5 контролей присутствия из шести.
                            Участникам, выполнившим все требования мероприятия, выдаются индивидуальные коды.
                            <br/><br/>
                            2) Для участия в мероприятии (очное участие) необходимо обязательно предварительно зарегистрироваться на сайте
                            <a className={'font-bold text-green-two'} href={'https://pediatric-dermatology.ru'}>https://pediatric-dermatology.ru</a>
                            (https://pediatric-dermatology.ru/) указав следующие данные: <br/>1. ФИО, <br/>2. Электронный адрес <br/>3. Место работы,
                            ...
                            "`Ломоносов`" (ИНТЦ МГУ Воробьёвы горы, Раменский бульвар, 1) с 10:00 - 18:30. Участникам, выполнившим все требования
