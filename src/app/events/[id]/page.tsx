                ...
                {event?.date == '09.11.2024' || event?.date == '2023-11-09' ?
                    <div className={'flex flex-col gap-2'}>
                        ...
                        <p className={'whitespace-pre-wrap mt-2 px-[20px] lg:px-[140px] text-black'}>
                            ...
                            обратной связи являются &quot;Чат трансляции&quot;. Участниками мероприятия будут признаны слушатели, присутствующие 9 ноября 2024 года (1 день) - не менее 225 минут для программы НМО на трансляции и подтвердившие 4 контроля присутствия из 5.
