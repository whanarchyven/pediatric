...
import Partners0706 from "@/components/Partners0706";
            ...
            {!event?.isOnlyOnline && event?.type != 'Марафон' && (registration?.meta?.participationType != "online-free"||isAdmin)&& (new Date(needPrice.date).setHours(0,0,0,0) >= new Date().setHours(0,0,0,0))?
                <div className={'bg-white relative lg:py-0 py-12 px-[20px] lg:px-[140px] '}>
                    ...
                    {((event?.date != '11.11.2023' && !registration) || isAdmin) ? (<div
                        ...
                        {(needPrice?.offline&&event?.date!='07.06.2025')||(isAdmin) ? <div className={'flex flex-col items-center gap-8'}>
                            <div
                ...
                {event?.date == '07.06.2025'?
                    <div className={'flex flex-col gap-2'}>
                        ...
                        <p className={'whitespace-pre-wrap mt-2 px-[20px] lg:px-[140px] text-black'}>
                            ...
                            разные временные интервалы. Вход на трансляцию осуществляется не ранее, чем за 2 часа до её
                            начала. При завершении трансляции, сеанс у всех присутствующих прекращается. Инструментами
                            обратной связи являются `&quot;`Чат трансляции`&quot;`. Участниками мероприятия будут признаны слушатели, присутствующие 7 июня 2025 года (1 день) - не менее 385 минут на трансляции и подтвердившие 6 контролей присутствия из 8. Участникам, выполнившим все требования в мероприятии, выдаются индивидуальные коды.
                            <br/><br/>
                            ...
                            с последующим контролем присутствия до окончания мероприятия. Участниками мероприятия будут
                            признаны слушатели, присутствующие 7 июня 2025 года (1 день) по адресу кибердом - инновационный IT-кластер, г. Москва, ул. 2-я звенигородская, д. 12, строение 18 с 10:00-18:00. Участникам, выполнившим все требования в мероприятии, выдаются индивидуальные коды.
                        </p>
                    </div> : null}
