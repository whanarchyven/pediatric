...
const send = async () => {
  ...
  async function getUsers() {
    ...
    const data = require(path.join(__dirname, 'users.json'));

    const users=data['users'].filter(item=>item.joinCommunity==true)
...
// //                                                     <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
// //                                                         <tr>
// //                                                             <td align="left" style="padding:0;Margin:0"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px"><em><span style="font-size:24px"><strong>Уважаемый ${user.lastName} ${user.firstName} ${user.middleName} ! </strong></span></em></p></td>
// //                                                         </tr>
// //                                                     </table></td>
// //                                             </tr>
// //                                         </table></td>
...
// //                                                         <tr>
// //                                                             <td style="padding:0;Margin:0"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">Рады сообщить, что Ваша заявка успешно прошла аккредитацию, и Вы стали полноправным членом Общества детских дерматологов! Поздравляем Вас с этим важным шагом в Вашем профессиональном развитии.
// //                                                                 <br/><br/>Мы прикрепляем к этому письму Ваш сертификат, подтверждающий членство. Также Вы можете найти его в Вашем личном кабинете на нашем сайте.<br/><br/>С нетерпением ждем встречи с Вами 9 ноября на нашем ключевом событии года – X Юбилейной Всероссийской научно-практической конференции с международным участием «Дерматологические чтения в педиатрии».<br/><br/>Ссылка на сертификат: <a href="https://www.pediatric-dermatology.ru/account/${user.uuid}/certificate/">https://www.pediatric-dermatology.ru/account/${user.uuid}/certificate/</a><br/><br/></p></td>
// //                                                         </tr>
// //                                                         <tr>
...
//     //   subject: "Сертификат члена общества",
//     //   html: htmlTemp,
//     //
//     // });
//     // console.log(status)
